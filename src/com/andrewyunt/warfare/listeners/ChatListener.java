...
public class ChatListener implements Listener {
    ...
    public ChatListener(Warfare plugin) {
        this.plugin = plugin;
    }

    public static final List<String> blocked = Arrays.asList("ikari","cheatbreaker","cheat breaker","nigga", "kill yourself", "nigger", "prime", "pulsepvp", "para", "plugins", "plugin", "p4ra", "rip off", "shit staff", "shit server", "gay server", "kys", "leaked", "ddos", "velt", "hcteams", "minehq", "kill yourself", "viper", "oxpvp", "togglinq", "hydrahcf", "purgepots", "shit owner", "fuck this", "crap server", "crap staff", "bad staff", "gay staff", "etb", "exploitsquad", "arson", "lag", "botted", "fake players", "bot players", "my server", "join my server", "hcgames", "hcsquads", "server is shit", "server is crap", "server is so", "anticheat", "anti cheat", "bad server", "faggot", "anti-cheat", "hydra", "endyou", "whatspuberty", "kult", "this is shit", "staff", "mods", "arsonhcf", "spoofing", "playercount", "minehq", "customkkk", "restart", "#keyall", "#another","rollback","admins","stuck");
    ...
    public void onPlayerChat(AsyncPlayerChatEvent e){
        ...
        String prefix = ChatColor.YELLOW + ChatColor.translateAlternateColorCodes('&', prefixpex) + player.getName() + " " + (player.hasPermission("practice.silverarrow") ? ChatColor.DARK_GRAY : ChatColor.GOLD) + "» " + ChatColor.GRAY;
