 ...
 */
package com.andrewyunt.skywarfare.managers;
...
public class SignManager {
	...
	public void deleteSign(SignDisplay sign) throws SignException {
		...
		SignConfiguration signConfig = SkyWarfare.getInstance().getSignConfig();
	...
	public void loadSigns() {
		...
		if (!SkyWarfare.getInstance().getSignConfig().getConfig().contains("signs"))
			return;

		ConfigurationSection signs = SkyWarfare.getInstance().getSignConfig().getConfig()
